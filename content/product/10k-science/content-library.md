---
title: 10k Science Content Library
status: public
audiences: [educators, students, researchers, institutions]
topics: [content-library, experiences, real-science-data, ngss, biology, chemistry, environmental-science, health-science]
description: Public overview of the 10k Science content library, including immersive science experiences, learning topics, and curriculum connections.
...
- [NGSS standards search](https://www.nextgenscience.org/search-standards)
- [NGSS disciplinary core ideas overview](https://www.nextgenscience.org/overview-dci)
- [NGSS crosscutting concepts]({{ site.baseurl }}/content/audiences/educators/#crosscutting-concepts)
...
Learn more on the [Researchers And Creators]({{ site.baseurl }}/content/audiences/researchers-and-creators/) page.
